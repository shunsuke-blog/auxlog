...
import {
  ...
  buildSlotSelections as buildSlotSelectionsPure,
  HIDDEN_ONBOARDING_NAMES,
  type ExerciseMasterRow,
} from '@/lib/onboarding/exercise_matching'
...
export default function OnboardingClient({ exercises }: Props) {
  ...
  const buildSlotSelections = () => buildSlotSelectionsPure({
    daysPerWeek,
